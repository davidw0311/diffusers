...
try:
    ...
    _import_structure["pipeline_stable_diffusion_mdCustom"] = ["StableDiffusionPipeline_mdCustom"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_mdCustom import (
            StableDiffusionPipeline_mdCustom,
        )
